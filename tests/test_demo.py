...
import demo  # Import your module
...
def test_calculate_area_circle():
    ...
    assert demo.calculate_area_circle(5) == 3.14 * 5 * 5
    assert demo.calculate_area_circle(0) == 0
    assert demo.calculate_area_circle(1) == 3.14


def test_calculate_area_circle_negative():
    """Test the calculate_area_circle function with a negative radius."""
    assert demo.calculate_area_circle(-5) == 3.14 * 25

...
select
  ...
  select material_cd where acdoca.matnr = material.material_cdunionselect subbrand_nm where acdoca.ZZ1_GPHLVL5_MSE= material.prod_hier_l9_cd as product_cd_nk,
  ...
  "select characteristic_value_vl from amer_dc_md.t_dim_material_classificationwhere class_name_nm = """"Z_MATERIAL_GENERAL"""" and characteristic_name_nm = 'Snack Type'" as snack_type,

...
value from Dim table as to_consigner_city */ ordr.to_consigner_city as to_consigner_city,
  ...
  /* CALC LOGIC: take coordinator_country column from dim_consignor as to_consigner_country */ ordr.to_consigner_country as to_consigner_country,
...
`dev-meu-analyt-lops-svc-28.meu_ds_lops.v_dim_transportation_coordinator`  as dim_receiver on columns recipient_id_sk and dim_transportation_coordinator_sk repectively and take coordinator_city from view v_dim_transportation_coordinator  as dim_receiver */ ordr.to_recipient_city as to_recipient_city,
  ...
  /* CALC LOGIC: take coordinator_country column from dim_receiver */ ordr.to_recipient_country as to_recipient_country,
...
from ordr
-- joins and logic as per mapping_reference_calculation